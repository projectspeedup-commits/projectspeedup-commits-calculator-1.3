...
function fix(filePath) {
    ...
    content = content.replace(/<td className="text-left px-4 py-3 text-slate-800 dark:text-slate-200 align-middle" style="text-align:center;vertical-align:middle;">/g, '<td style="text-align:center;vertical-align:middle;">');
