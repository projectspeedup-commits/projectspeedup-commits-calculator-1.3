                          ...
                          <h4 className="text-sm sm:text-base font-black text-slate-900 dark:text-white uppercase tracking-widest">
                            Планы поставок сырья
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span 
                                    className="text-[15px] font-bold bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-300 rounded-full flex items-center justify-center px-4 min-h-[34px]"
                                  >
