                      ...
                      onClick={() => {
                        ...
                        const worksheetData = [
                          ...itemsToProcess.map((res: any) => {
                             return {
                                "Внутренний номер": res.internalNo || "",
                                "Дата отгрузки": res.shippingDate 
                                    ? new Date(
                        ...
                        XLSX.writeFile(workbook, "Портфель_заказов.xlsx");
                      }}
                                ...
                                onClick={() => {
                                  ...
                                  const rows = calculationResults.map((res) => {
                                    ...
                                    if (!isPurchasingMode) {
                                      row.push(
                                        Number(res.price || 0),
                                        Number(res.totalCost.toFixed(0)),
                                      );
                                    }
                                    return row;
                                  });
